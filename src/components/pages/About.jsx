            ...
            <div className="container mx-auto px-6 mb-20">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="w-full md:w-1/2">
                        <span className="text-brand-orange font-serif italic text-xl mb-4 block">About Fasmala</span>
                        <h1 className="text-5xl font-serif font-bold text-brand-dark mb-6 leading-tight">
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="relative">
                            ...
                            />
                            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-brand-orange/10 rounded-full -z-0 hidden md:block" />
                            <div className="absolute -top-10 -right-10 w-20 h-20 bg-brand-dark/5 rounded-full -z-0 hidden md:block" />
                        </div>
                    </div>
                </div>
            </div>
